...
![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image.png)

## 强连通分量

一个环是强连通分量。一个没有出边的点也是强连通分量。

![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image 1.png)

如果一个子图可以构成多个连通分量，则只有包含节点最多的才是强连通分量。（如下图4，包含3个节点的环不是强连通分量，4个的才是 ）一个图中的强连通分量可以有多个，并且他们所包含的节点数可能不同（如上图1,2,3,4,9和5,6,8和7）

![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image 2.png)

分类之后，就可以通过不同的边寻找环，从而找到强连通分量

![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image 3.png)

![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image 4.png)

## Tarjan算法

![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image 5.png)

![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image 6.png)
...
![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image 7.png)
...
![image.png](强连通分量+7333256a-3137-4ee7-8ec2-517b40f2139d/image 8.png)
