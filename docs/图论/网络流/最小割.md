...
![image.png](最小割+05486c17-a23d-4b95-816b-669d038236ac/image.png)

注：容易划分均可

![image.png](最小割+05486c17-a23d-4b95-816b-669d038236ac/image 1.png)

如上图。左边为$S$，右边为$T$，$c(S,T)=7+6$即1→2和1→4的容量和，不包括从$T$到$S$的（即5→1）

![image.png](最小割+05486c17-a23d-4b95-816b-669d038236ac/image 2.png)

如上图。左边为$S$，右边为$T$，$c(S,T)=2+1+2$即2→3和2→5和4→5的容量和，不包括从$T$到$S$的（即5→1）

![image.png](最小割+05486c17-a23d-4b95-816b-669d038236ac/image 3.png)

![image.png](最小割+05486c17-a23d-4b95-816b-669d038236ac/image 4.png)

即：最大流的流量=最小割的容量

![image.png](最小割+05486c17-a23d-4b95-816b-669d038236ac/image 5.png)

请思考证明！

![image.png](最小割+05486c17-a23d-4b95-816b-669d038236ac/image 6.png)
