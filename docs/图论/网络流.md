...
![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image.png)

流量守恒：流入dianS的流量和=流出S的流量和

源点的流出流量和=整个网络的流量

![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 1.png)
...
![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 2.png)



![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 3.png)
...
![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 4.png)

请思考



![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 5.png)

# EK算法求最大流

过程

![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 6.png)
...
![https://cdn.luogu.com.cn/upload/pic/2262.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/2262.png)
...
![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 7.png)
...
![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 8.png)
...
![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 9.png)

注：容易划分均可

![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 10.png)

如上图。左边为$S$，右边为$T$，$c(S,T)=7+6$即1→2和1→4的容量和，不包括从$T$到$S$的（即5→1）

![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 11.png)

如上图。左边为$S$，右边为$T$，$c(S,T)=2+1+2$即2→3和2→5和4→5的容量和，不包括从$T$到$S$的（即5→1）

![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 12.png)

![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 13.png)

即：最大流的流量=最小割的容量

![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 14.png)

请思考证明！

![image.png](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/image 15.png)
...
见 [二分图 & 二部图问题](https://flowus.cn/d0a592ec-90fb-41ef-b721-a9cdb64d5068)
...
![https://pic1.zhimg.com/80/v2-5c7a4eaa79b5c9da4be7fb03658ba598_1440w.webp](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/v2-5c7a4eaa79b5c9da4be7fb03658ba598_1440w.webp)

做法是，我们把它**拆**成两个结构与原图相同的普通网络，一个每条边的容量为原网络对应边的**流量下界**，另一个为对应边的**流量上界与下界之差**。

![https://pic3.zhimg.com/80/v2-b2894f46d6e7b1f146a7dd5edb6be1d6_1440w.webp](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/v2-b2894f46d6e7b1f146a7dd5edb6be1d6_1440w.webp)
...
![https://pic1.zhimg.com/80/v2-f213c0b0ff05657a1b819179d195ba34_1440w.webp](网络流+db56502e-9cbd-4978-a11c-91bfeee6b4b6/v2-f213c0b0ff05657a1b819179d195ba34_1440w.webp)
