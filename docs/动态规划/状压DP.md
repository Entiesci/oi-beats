...
记录f_{i,j,k}为考虑第i行，第i-1,i行的状态分别为j,k的合法状态的最大状态数。为了知道i-1,i-2行的状态，我们从f_{i-1}转移来即可。
...
![https://cdn.luogu.com.cn/upload/pic/10868.png](状压DP+60456607-3106-48b4-93ac-cec48858ae26/10868.png)
